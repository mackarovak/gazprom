...
insert_devices([(device_name, user_id) for device_name, user_id in zip(device_data, range(1, len(user_names) + 1))])
...
async def startup_event():
    ...
    for data in data_to_insert:
        cur.execute("INSERT INTO statistics (x, y, z, id_device, time) VALUES (%s, %s, %s, %s, %s)", data)
...
async def insert_data(data: DataInsert):
    ...
    cur.execute("INSERT INTO statistics (x, y, z, id_device) VALUES (%s, %s, %s, %s)", (x, y, z, id_device))
